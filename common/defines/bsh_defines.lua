NDefines.NMilitary.COMBAT_SUPPLY_LACK_ATTACKER_ATTACK = -0.10
...
NDefines.NSupply.CAPITAL_INITIAL_SUPPLY_FLOW = 1.0
...
NDefines.NSupply.NAVAL_BASE_INITIAL_SUPPLY_FLOW = 0.7
...
NDefines.NSupply.FLOATING_HARBOR_BASE_SUPPLY = 2.0
NDefines.NSupply.FLOATING_HARBOR_BASE_DURATION = 2.8
...
NDefines.NSupply.RAILWAY_BASE_FLOW = 1
NDefines.NSupply.RAILWAY_FLOW_PER_LEVEL = 0.5
NDefines.NSupply.RAILWAY_MIN_FLOW = 0.1
NDefines.NSupply.NAVAL_BASE_FLOW = 1.5
NDefines.NSupply.NAVAL_FLOW_PER_LEVEL = 0.5
...
NDefines.NSupply.SUPPLY_PATH_MAX_DISTANCE = 5
