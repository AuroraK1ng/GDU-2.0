...
NDefines.NNavy.DAMAGE_PENALTY_ON_MINIMUM_POSITIONING = 0.7 					-- damage penalty at 0% positioning | 0.7
NDefines.NNavy.AA_EFFICIENCY_PENALTY_ON_MINIMUM_POSITIONING = 0.7  			-- AA penalty at 0% positioning | 0.7
NDefines.NNavy.SCREENING_EFFICIENCY_PENALTY_ON_MINIMUM_POSITIONING = 0.5  	-- screening efficiency (screen to capital ratio) at 0% positioning | 0.5
