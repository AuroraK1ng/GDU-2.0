...
NDefines.NNavy.FIELD_EXPERIENCE_MAX_PER_DAY = 3.5
...
NDefines.NRaids.RAID_UNIT_SPEED_MULTIPLIER = 0.4

NDefines.NGame.ENERGY_RESOURCE = "oil"
NDefines.NProduction.RESOURCE_TO_ENERGY_COEFFICIENT = 1000
NDefines.NProduction.BASE_COUNTRY_ENERGY_PRODUCTION = 99999.0
NDefines.NNavy.NAVAL_DOMINANCE_STRIKE_FORCE_FRACTION = 0
NDefines.NNavy.NAVAL_DOMINANCE_STRIKE_FORCE_MULTIREGION_DECAY = 0		-- Percentage that the strike force mission's naval dominance multiplier decreases with for each additional assigned region
NDefines.NNavy.NAVAL_DOMINANCE_SPOTTING_BONUS = 0
NDefines.NNavy.NAVAL_DOMINANCE_ORG_RECOVERY = 0
NDefines.NNavy.NAVAL_DOMINANCE_SHIP_RECOVERY_CHANCE = 0
NDefines.NNavy.NAVAL_DOMINANCE_MINES_PLANTING_BONUS = 0					-- Naval planting bonus when having naval dominance in the region
NDefines.NNavy.NAVAL_DOMINANCE_MINES_SWEEPING_BONUS = 0				-- Naval sweeping bonus when having naval dominance in the region
NDefines.NNavy.NAVAL_DOMINANCE_CHANCE_OF_ACCIDENT_REDUCTION = 0
NDefines.NDiplomacy.NAVAL_BLOCKADE_BASE_COST = 9999
NDefines.NDiplomacy.EMBARGO_COST = 9999
NDefines.NMilitary.COHESION_IMMOBILE_PLANNING_SPEED_MULTIPLIER = 1

NDefines.NNavy.NAVAL_INVASION_PLAN_CAP = 999
NDefines.NNavy.NAVAL_INVASION_PREPARE_DAYS = 20
...
NDefines.NNavy.DOMINANCE_DAILY_GAIN_FACTOR = 1
NDefines.NNavy.DOMINANCE_DAILY_LOSS_FACTOR = 0.05
NDefines.NNavy.NAVAL_COMBAT_PLANE_MIN_STACKING_PENALTY = 1500
NAVAL_COMBAT_PLANE_STACKING_PENALTY_EFFECT = 1